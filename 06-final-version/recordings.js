...
const createCurlStart = () => {
    const client = meeting.getClientInfo();
    return `curl -X POST https://api.eyeson.team/rooms/${client.accessKey}/recording`;
};

const createCurlStop = () => {
    const client = meeting.getClientInfo();
    return `curl -X DELETE https://api.eyeson.team/rooms/${client.accessKey}/recording`;
};
